...
% This function defines various prescribed layouts for WEC farms of different
% sizes. 
% The available layouts for 5-WEC farms includes:
%   'near-symmetrical',
%   'far-symmetrical', 
%   'row',
%   'column', 
%   'asymmetrical'
%
% Additional layouts can be defined this function by the user. 
% 
